 ...
 * 
 */
public class C4TgzClusterActionHandlerFactory extends ClusterActionHandlerFactory {

  @Override
  public String getRolePrefix() {
    return C4TGZ_ROLE_PREFIX;
  }

  @Override
  public ClusterActionHandler create(String roleName) {
    return new C4TgzClusterActionHandler(checkNotNull(roleName, "roleName"));
  }
