...
import static org.apache.whirr.service.c4tgz.C4TgzConstants.MODULE_KEY_PATTERN;
...
import org.apache.whirr.service.c4tgz.statements.InstallModuleFromGit;
...
public class StatementToInstallModule implements Function<Map<String, String>, Statement> {
  ...
  private Statement installModuleFromRemoteFileOrGit(String roleKey, Map<String, String> props) {
    String moduleName = roleKey.substring(C4TGZ.length() + 1).replaceAll("\\..*", "");
